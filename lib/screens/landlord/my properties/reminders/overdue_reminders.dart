                  ...
                  ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      return Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          //OverDue Reminders Details Card
                          _builOverDueRemindersDetailsCard(),
                        ],
                      );
                    },
                  ),
...
//------------------------------ OverDue Reminders Details Card ---------------------/
  ...
  Widget _builOverDueRemindersDetailsCard() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
                    ...
                    Flexible(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "25 Marylebone Road, London EC71 OBE",
                            style:
      ...
      children: const [
        SizedBox(
          ...
          child: RoundedLgShapeWidget(
            ...
            title: StaticString.overDueReminders,
          ),
        ),
      ],
    );
  ...
  AppBar _buildAppBar(BuildContext context) {
    return AppBar(
      ...
      title: const CustomText(
        txtTitle: StaticString.myReminders,
      ),
    );
  }
}
