...
class LandLordRejecteScreen extends StatefulWidget {
  const LandLordRejecteScreen({super.key});

  @override
  State<LandLordRejecteScreen> createState() => _LandLordRejecteScreenState();
}

class _LandLordRejecteScreenState extends State<LandLordRejecteScreen> {
//-------------------------------------- UI ---------------------------------------//
  @override
