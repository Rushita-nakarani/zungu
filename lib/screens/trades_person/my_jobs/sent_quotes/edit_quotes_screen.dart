...
class EditQuotesScreen extends StatefulWidget {
  const EditQuotesScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text(StaticString.editQuote),
      ),
      body: _buildBody(),
    );
  }
            ...
            child: Column(
              ...
              children: [
                ...
                CommonElevatedButton(
                  bttnText: StaticString.editAndResend,
                  color: ColorConstants.custGreenAFCB1F,
                  fontSize: 14,
                  height: 40,
                  onPressed: editAndResendBtnOnTap,
                )
              ],
            ),
          ),
