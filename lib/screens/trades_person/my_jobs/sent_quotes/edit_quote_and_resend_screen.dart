...
import 'edit_quotes_screen.dart';

class EditQuoteAndResendScreen extends StatefulWidget {
  final LatestJobModel latestJobModel;
  const EditQuoteAndResendScreen({super.key, required this.latestJobModel});

  @override
  State<EditQuoteAndResendScreen> createState() =>
      _EditQuoteAndResendScreenState();
}

class _EditQuoteAndResendScreenState extends State<EditQuoteAndResendScreen> {
  //------------------------------------Variables---------------------------//
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const CustomText(
          txtTitle: StaticString.sentQuoteseditResendJobs,
        ),
      ),
      body: _buildBody(),
    );
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    // call card
                    _customconCard(icon: ImgName.callGreen, onTap: () {})
                  ],
                ),
              ),
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    _customconCard(
                      icon: ImgName.editGreen,
                      onTap: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (ctx) => const EditQuotesScreen(),
                          ),
                        );
                      },
                    )
                  ...
                  children: [
                    ...
                    Expanded(
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: deleteQuoteBtnAction,
                          ...
                          child: CustomText(
                            align: TextAlign.center,
                            txtTitle: StaticString.deleteQuote,
                            style:
                                Theme.of(context).textTheme.caption?.copyWith(
                                      wordSpacing: 1.5,
                                      fontSize: 15,
                    ...
                    Expanded(
                      child: SizedBox(
                        height: 35,
                        child: ElevatedButton(
                          onPressed: resendQuoteBtnAction,
                          style: ElevatedButton.styleFrom(
                            backgroundColor: ColorConstants.custDarkTeal017781,
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(
                          ...
                          child: CustomText(
                            align: TextAlign.center,
                            txtTitle: StaticString.resendQuote,
                            style:
                                Theme.of(context).textTheme.caption?.copyWith(
                                      wordSpacing: 1.5,
                                      fontSize: 15,
  ...
  // Custom Icon Card
  Widget _customconCard({required String icon, required Function() onTap}) {
    return Container(
      padding: const EdgeInsets.all(3),
      decoration: BoxDecoration(
        color: Colors.white,
  ...
  //Decline job buttom action
  void deleteQuoteBtnAction() {
    showAlert(
      context: context,
      title: StaticString.deleteQuote1,
      message: StaticString.deleteQuoteMsg,
      singleBtnColor: ColorConstants.custRedE03816,
      singleBtnTitle: StaticString.deleteQuote,
      showIcon: false,
    );
  }

  //Accept job buttom action
  void resendQuoteBtnAction() {}
}
