...
import '../confirmed_jobs/confirmed_jobs_screen.dart';
import 'decline_job_bottomsheet.dart';

class AcceptAndDeclineJobScreen extends StatefulWidget {
  final LatestJobModel latestJobModel;
  const AcceptAndDeclineJobScreen({super.key, required this.latestJobModel});

  @override
  State<AcceptAndDeclineJobScreen> createState() =>
      _AcceptAndDeclineJobScreenState();
}

class _AcceptAndDeclineJobScreenState extends State<AcceptAndDeclineJobScreen> {
  //------------------------------------Variables---------------------------//
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const CustomText(
          txtTitle: StaticString.sentQuotesAcceptDeclineJobs,
        ),
      ),
      body: _buildBody(),
    );
                    ...
                    Expanded(
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: CustomText(
                            align: TextAlign.center,
                            txtTitle: StaticString.declineJob,
                            style:
                                Theme.of(context).textTheme.caption?.copyWith(
                                      wordSpacing: 1.5,
                                      fontSize: 15,
                    ...
                    Expanded(
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: CustomText(
                            align: TextAlign.center,
                            txtTitle: StaticString.acceptJob,
                            style:
                                Theme.of(context).textTheme.caption?.copyWith(
                                      wordSpacing: 1.5,
                                      fontSize: 15,
  ...
  void acceptJobBtnAction() {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (ctx) => const ConfirmedJobsScreen(),
      ),
    );
  }
}
