//---------------------------- Trades Confirmed Viewings Screen --------------------//
...
class TradesConfirmedViewingsScreen extends StatefulWidget {
  const TradesConfirmedViewingsScreen({super.key});

  @override
  State<TradesConfirmedViewingsScreen> createState() =>
      _TradesConfirmedViewingsScreenState();
}

class _TradesConfirmedViewingsScreenState
    extends State<TradesConfirmedViewingsScreen> {
//-------------------------------------- UI ----------------------------------------//
  @override
